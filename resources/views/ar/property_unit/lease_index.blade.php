...
@section('page_title','unit_leases')
@extends('template')
...
@section('content')
    ...
    <div class="row">
      <div class="col-md-12">
        @include('ar.tabs.property_unit',['property_name' => $unit_name])
        <div class="portlet light bordered ">
          <div class="portlet-title">
            ...
            <div class="actions">
                ...
                <a class="btn blue btn-outline" href="{{action('Property_unitController@create_lease',$unit_name)}}">
                    اضافة
            ...
            <table class="table table-hover table-striped"> 
                ...
                <tbody> 
                        ...
                        <tr>
                            ...
                            <td>{{$result[$i]->lease_signature_date}}</td> 
