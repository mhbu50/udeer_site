                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <div class='raw pd-0-p'>
                              <div class='col-md-8'>
                                <input type="number" class="form-control" id="annual_rent_amount" placeholder="" name='annual_rent_amount' value='{{ isset($property_unit->annual_rent_amount) ? $property_unit->annual_rent_amount : ""}}'>
                              </div>
                              <div class='col-md-4'>
