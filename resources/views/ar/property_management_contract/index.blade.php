        ...
        <div class="portlet light bordered ">
          <div class="portlet-title">
            ...
            <div class="actions">
                ...
                <a class="btn blue btn-outline" href="/property_management_contract/create">
                    اضافة
                    <i class="fa fa-plus"></i>
                </a>
                <a class="btn red btn-outline c-btn-tp" href="javascript:;" id="del-btn" doctype="property_management_contract">
                    مسح
          ...
          <div class="portlet-body form">
            ...
            <table class="table table-hover table-striped"> 
                ...
                <tbody> 
                        ...
                        <tr>
                            <th scope="row"><a href="{!!action('Property_management_contractController@edit',['name'=>$result[$i]->name])!!}">{{ $result[$i]->name  }}</a></th>
                            <td>{{$result[$i]->property}}</td>
                            <td>{{$result[$i]->signature_date}}</td>
