        ...
        <div class="portlet light bordered ">
          <div class="portlet-title">
            ...
            <div class="actions">
                ...
                <a class="btn blue btn-outline" href="/debt/create">
                    اضافة
                    <i class="fa fa-plus"></i>
                </a>
                <a class="btn red btn-outline c-btn-tp" href="javascript:;" id="del-btn" doctype="debt">
                    مسح
          ...
          <div class="portlet-body form">
            ...
            <table class="table table-hover table-striped"> 
                <thead> 
                    <tr>  
                        <th>#</th>
                        <th><div class="th-inner ">اسم المدين</div></th>  
