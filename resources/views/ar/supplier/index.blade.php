        ...
        <div class="portlet light bordered ">
          <div class="portlet-title">
            ...
            <div class="actions">
                ...
                <a class="btn blue btn-outline" href="/supplier/create">
                    اضافة
                    <i class="fa fa-plus"></i>
                </a>
                <a class="btn red btn-outline c-btn-tp" href="javascript:;" id="del-btn" doctype="Supplier">
                    مسح
                    <i class="icon-trash"></i>
                    <input type='hidden' name='_token' class="token" value="{!! csrf_token() !!}" />
                    <input name="names" id="del-arr" hidden/>
                </a>
                <a class="btn btn-outline  buttons-html5 btn yellow btn-outline" tabindex="0" aria-controls="" href="#"><span>اكسل</span></a>
            </div>
            ...
            <table class="table table-hover table-striped"> 
                <thead> 
                    <tr> 
                        ...
                        <th><div class="th-inner ">اسم مزود الخدمة</div></th> 
                        <th><div class="th-inner ">نوع الخدمة</div></th> 
                        <th></th> 
                    </tr> 
                </thead> 
                <tbody> 
