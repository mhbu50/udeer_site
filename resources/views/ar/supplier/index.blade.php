        ...
        <div class="col-md-9">
            <div class="row">
                <div class="col-md-2">
                    ...
                    <a class="btn btn-default c-btn-tp" href="{{action('SupplierController@create')}}">اضافة</a>
                </div>
                <div class="col-md-2">
                    <form action="{!!action('SupplierController@delete_array')!!}" method="post">
            ...
            <div class="raw">
                ...
                <div class="" >
                    <div id="" class="page-content">
                        @if(count($result))
                        <form action="{!!action('SupplierController@set_index')!!}" method="post">
                            <input type='hidden' name='_token' value="{!! csrf_token() !!}">
                            <div class="raw">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type="text" name="supplier_name" class="form-control" placeholder="اسم مزود الخدمة"/>
                                    </div>  
                                </div>
