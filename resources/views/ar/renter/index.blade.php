        ...
        <div class="portlet light bordered ">
          <div class="portlet-title">
            ...
            <div class="actions">
                ...
                <a class="btn blue btn-outline" href="/renter/create">
                    اضافة
                    <i class="fa fa-plus"></i>
                </a>
                <a class="btn red btn-outline c-btn-tp" href="javascript:;" id="del-btn" doctype="Customer">
                    مسح
            ...
            <table class="table table-hover table-striped"> 
                <thead> 
                    <tr>  
                        ...
                        <th><div class="th-inner ">اسم العميل</div></th>
                        <th><div class="th-inner ">بريد الالكتروني</div></th>  
                        <th></th> 
                    </tr> 
                </thead> 
                <tbody> 
        ...
        <div class="col-md-9">
            ...
            <div class="row index-head-btn_wrp">
                <div class="col-md-2">
                    ...
                    <a class="btn btn-default c-btn-tp" href="{{action('RenterController@create')}}">اضافة</a>
                </div>
                <div class="col-md-2">
                     <form c-url="{!!action('UdeerController@delete_array')!!}" method="post" class="del_arr">
                        <input type='hidden' name='_token' value="{!! csrf_token() !!}" />
                        <input type='hidden' name='doctype' value="Customer"/>
                        <input name="names" id="del-arr" hidden/>
