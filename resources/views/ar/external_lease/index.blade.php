        ...
        <div class="portlet light bordered ">
          <div class="portlet-title">
            ...
            <div class="actions">
                ...
                <a class="btn blue btn-outline" href="/external_lease/create">
                    اضافة
                    <i class="fa fa-plus"></i>
                </a>
                <a class="btn red btn-outline c-btn-tp" href="javascript:;" id="del-btn" doctype="external_lease">
                    مسح
          ...
          <div class="portlet-body form">
            ...
            <table class="table table-hover table-striped"> 
                ...
                <tbody> 
                        ...
                        <tr>
                            <th scope="row"><a href="{!!action('External_leaseController@edit',['name'=>$result[$i]->name])!!}">{{ $result[$i]->name  }}</a></th>
                            <td>{{$result[$i]->seller_name}}</td>
                            <td>{{$result[$i]->buyer_name}}</td>
                            <td>{{$result[$i]->lease_start_day}}</td> 
