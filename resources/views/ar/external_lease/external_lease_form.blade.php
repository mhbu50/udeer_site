<form method='post' action="{{$action}}" enctype="multipart/form-data">
    ...
    <div class="col-md-6">
        ...
        <div class="form-group form-md-line-input form-md-floating-label">
            <select class="form-control" id="seller_id_type" placeholder="" name="seller_id_type">
                <option value=""></option>
                <option value="eghama"></option>
                <option value="national_id_card"></option>
            </select>
    ...
    <div class="col-md-6">
        ...
        <div class="form-group form-md-line-input form-md-floating-label">
            <div class="input-icon right">
                <input class="form-control form-control-inline date-picke" size="16" type="date" value="" id="buyer_id_expire" placeholder="" name="buyer_id_expire">
                <i class="fa fa-calendar"></i>  
                <label for="expiry_date">تاريخ انتهاء الهوية</label>       
            </div>
        </div>
