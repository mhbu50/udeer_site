        ...
        <div class="portlet light bordered ">
          <div class="portlet-title">
            ...
            <div class="actions">
                ...
                <a class="btn blue btn-outline" href="/property_owner/create">
                    اضافة
                    <i class="fa fa-plus"></i>
                </a>
            <a class="btn red btn-outline c-btn-tp" href="javascript:;" id="del-btn" doctype="property_owner">
                    مسح
            ...
            <table class="table table-hover table-striped"> 
                <thead> 
                    <tr>  
                        ...
                        <th><div class="th-inner ">اسم المالك</div></th>
                        <th><div class="th-inner ">بريد الالكترونية</div></th>  
                        <th></th> 
                    </tr> 
                </thead> 
                <tbody> 
