...
<body id="" class="financial_system ">
        ...
        <div class="col-md-9">
            ...
            <div class="row index-head-btn_wrp">
                <div class="col-md-2">
                    ...
                    <a class="btn btn-default c-btn-tp" href="{{action('ReceiptController@create')}}">اضافة</a>
                </div>
                <div class="col-md-2">
            ...
            <div class="raw">
                <div class="" >
                    <div id="" class="page-content">
                        @if(count($result))
                         <form action="{!!action('ReceiptController@set_index')!!}" method="post">
                            <input type='hidden' name='_token' value="{!! csrf_token() !!}">
                                ...
                                <tbody> 
                                    <tr>
                                     @for ($i = 0; $i < count($result); $i++)
                                        <th scope="row"><a href="{!!action('ReceiptController@edit',$result[$i]->name )!!}">{{ $result[$i]->name  }}</a></th>
