	...
	private function _curl(
			...
			switch($method){
				...
				case 'INSERT':
						...
						// echo $url.'//////////////'.json_encode($params['data']).'///////';
				...
				default:
						...
						$url = $this->_api_url.$params['doctype'].'/'.($params['data']);
						$ch = curl_init($url);
						curl_setopt($ch,CURLOPT_CUSTOMREQUEST, 'GET');
					break;
			}
			...
			$ss = curl_setopt($ch,CURLOPT_COOKIEJAR, $this->_cookie_file);
			var_dump('sss,');
